      ...
      >
        <Grid container>
          ...
          <Paper
            square={true}
            elevation={0}
            sx={{ width: "10%", flexDirection: "row-reverse" }}
            component={Stack}
            direction="row"
          >
            <IconButton
              disableRipple={true}
              onClick={() => {
                props.setShowFullGraph(!props.showFullGraph);
              }}
            >
          ...
          >
            ...
            <Typography align="center">Publications</Typography>
          </Paper>
          <Paper
            square={true}
            elevation={0}
          ...
          >
            ...
            <Typography align="center">H-Index (5 Years)</Typography>
          </Paper>
          <Paper
            square={true}
            elevation={0}
          ...
          <PublicationBarGraph
            ...
            barGraphData={props.barGraphData}
          ></PublicationBarGraph>
        </Grid>
      </Paper>
    </Grid>
